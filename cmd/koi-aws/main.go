// Command koi-aws is the AWS plugin (#79): one resident process, four
// capabilities on one connection (the koi-git pattern) — the %p{aws}
...
func main() {
	...
	if err != nil {
		fmt.Fprintln(os.Stderr, "koi-aws:", err)
		os.Exit(1)
	}
