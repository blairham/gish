// Command koi-p10k serves the native powerlevel10k presets over the
...
//
// koi itself does not need this: KOI_THEME=p10k renders in-process,
...
// independently of the koi release it runs against, and a working
...
func newPlugin() pluginsdk.Plugin {
	p := pluginsdk.Plugin{Theme: theme{}}
