...
func TestBackgroundCommandIsAJob(t *testing.T) {
	...
	// process, because koi under the test pty cannot exec pgrep itself.
...
func TestKillByJobSpec(t *testing.T) {
	...
	// stale entry, without koi's kill involved at all. Asserting on the
