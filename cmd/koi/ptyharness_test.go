...
// One harness for every test that drives koi through a real pty.
//
...
// ptySession is one koi process on a pty.
...
type ptyOptions struct {
	// Args are koi's arguments; empty means an interactive shell.
	Args []string
